...
class Auth extends CI_Controller
{
    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $this->template->load('template/layout_2', 'auth/login', $this->data);
    ...
    public function profile()
    {
        ...
        $data = array(
            // Setando o template
            $this->template->set('titulo', 'Perfil do usuário'),
            $this->template->set('descricao', 'Página do perfil de usuário'),
            $this->template->set('author', 'Ricardo Santos Tobias'),
        ...
        if ($this->form_validation->run() === FALSE) {
            $this->_render_page('admin/user/profile_view', 'admin_master');
        } else {
            $new_data = array(
                'first_name' => $this->input->post('first_name'),
                'last_name' => $this->input->post('last_name'),
