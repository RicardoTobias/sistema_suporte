                ...
                <div class="table-responsive">
                    <table class="table table-bordered dataTable table-sm" width="100%" cellspacing="0">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_ID;"></i> ID</th>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_FILIAL;"></i> Filial</th>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_DTINI;"></i> Início</th>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_EVENTO;"></i> Evento</th>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_STATUS;"></i> Status</th>
                                <th class="text-center"><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="C1E_ATIVO;"></i> Ativo</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($listarDados as $empresa) : ?>

                                <tr>

                                    <td class="text-center"><?= $empresa->C1E_ID; ?></td>
                                    <td class="text-center"><?= $empresa->C1E_CODFIL; ?></td>
                                    <td class="text-center"><?= $empresa->C1E_DTINI; ?></td>

                                    <td class="text-center">
                                        <?php if ($empresa->C1E_EVENTO == 'I') : ?>
                                            <span class="badge badge-success">Inclusão</span>
                                        <?php elseif ($empresa->C1E_EVENTO == 'A') : ?>
                                            <span class="badge badge-warning">Alteração</span>
                                        <?php elseif ($empresa->C1E_EVENTO == 'E') : ?>
                                            <span class="badge badge-danger">Exclusão</span>
                                        <?php endif; ?>
                                    </td>

                                    <td class="text-center">
                                        <?php if ($empresa->C1E_STATUS == ' ') : ?>
                                            <span class="badge badge-primary">Não processado</span>
                                        <?php elseif ($empresa->C1E_STATUS == '1') : ?>
                                            <span class="badge badge-primary">Válido</span>
                                        <?php elseif ($empresa->C1E_STATUS == '2') : ?>
                                            <span class="badge badge-info">Aguardando retorno</span>
                                        <?php elseif ($empresa->C1E_STATUS == '3') : ?>
                                            <span class="badge badge-danger">Inconsistente</span>
                                        <?php elseif ($empresa->C1E_STATUS == '4') : ?>
                                            <span class="badge badge-success">Aceito RET</span>
                                        <?php elseif ($empresa->C1E_STATUS == '6') : ?>
                                            <span class="badge badge-info">Aguardando retorno Exclusão</span>
                                        <?php elseif ($empresa->C1E_STATUS == '7') : ?>
                                            <span class="badge badge-danger">Excluído RET</span>
                                        <?php endif; ?>
                                    </td>

                                    <td class="text-center">
                                        <?php if ($empresa->C1E_ATIVO == '1') : ?>
                                    ...
                                    <td class="text-center">
                                        <?php if ($empresa->D_E_L_E_T_ == '*') : ?>

                                            <a href="javascript(void);" class="btn btn-outline-success btn-sm" data-tt="tooltip" data-placement="top" data-toggle="modal" data-target="#ativar-<?= $empresa->R_E_C_N_O_; ?>" title="Recuperar registro">
                                                <i class="fas fa-check"></i>
                                            </a>

                                        <?php else : ?>

                                            <a href='<?= base_url($url . '/editar/' . $empresa->R_E_C_N_O_) ?>' class='btn btn-outline-primary btn-sm' data-tt="tooltip" data-placement='top' data-target="#editar" title='Editar'>
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <a href="javascript(void);" class="btn btn-outline-danger btn-sm" data-tt="tooltip" data-placement="top" title="Excluir" data-toggle="modal" data-target="#deletar-<?php echo $empresa->R_E_C_N_O_; ?>">
                                ...
                                <!-- DELETANDO DADOS -->
                                <div class="modal fade" id="deletar-<?= $empresa->R_E_C_N_O_; ?>" tabindex="-1" role="dialog" aria-labelledby="filtro" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content rounded-4 shadow">
                                            <form method="POST" action="<?= base_url($url . '/excluir/' . $empresa->R_E_C_N_O_); ?>">
                                ...
                                <!-- ATIVANDO DADOS -->
                                <div class="modal fade" id="ativar-<?= $empresa->R_E_C_N_O_; ?>" tabindex="-1" role="dialog" aria-labelledby="filtro" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content rounded-4 shadow">
                                            <form method="POST" action="<?= base_url($url . '/ativar/' . $empresa->R_E_C_N_O_); ?>">
                                                <div class="modal-body p-4 text-center">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_ID;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Begin TOOLTIP -->
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_CODFIL;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Begin TOOLTIP -->
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_DTINI;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
                        ...
                        <div class="row mb-4 collapse" id="moreFilter">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Begin TOOLTIP -->
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_EVENTO;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Begin TOOLTIP -->
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_STATUS;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Begin TOOLTIP -->
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" data-tt="tooltip" data-placement="top" title="Campo: C1E_ATIVO;">?</button>
                                    </div>
                                    <!-- End TOOLTIP -->
