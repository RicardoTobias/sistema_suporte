<form method="POST">
    <div class="row mb-4">
        ...
        <div class="col-md-12">
            <label for=""><i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="MenuCategoria;"></i>
                Categoria Menu</label>
            <div class="input-group">
                <input type="text" class="form-control" id="MenuCategoria" name="MenuCategoria" value="<?= $dados->MenuCategoria; ?>">
            </div>
        </div>
