                    ...
                    <div class="col-md-12 mt-3">
                        <h2><i class="far fa-newspaper"></i> <?= $titulo; ?>
                            <span class="float-right">
                                ...
                                <i class="fas fa-plus"></i> Criar registro</a>
                            </span>
                        </h2>
                    </div>
                </div>
                            ...
                            <?php foreach ($listarDados as $artigo) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='<?= base_url($url . '/editar/' . $artigo->id_artigo) ?>' class='pt-0 pb-0 btn btn-outline-primary btn-sm' data-tt="tooltip" data-placement='top' data-target="#editar" title='Editar'>
                                ...
                                <div class="modal fade" id="deletar-<?= $artigo->id_artigo; ?>" tabindex="-1" role="dialog" aria-labelledby="filtro" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content rounded-4 shadow">
                                            <form method="POST" action="<?= base_url($url . '/excluir/' . $artigo->id_artigo); ?>">
                                ...
                                <div class="modal fade" id="ativar-<?= $artigo->id_artigo; ?>" tabindex="-1" role="dialog" aria-labelledby="filtro" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content rounded-4 shadow">
                                            <form method="POST" action="<?= base_url($url . '/ativar/' . $artigo->id_artigo); ?>">
                                                <div class="modal-body p-4 text-center">
