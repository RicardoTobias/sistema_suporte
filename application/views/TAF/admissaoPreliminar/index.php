                        ...
                        <table class="table table-striped table-bordered dataTable table-sm" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <i class="far fa-question-circle" data-tt="tooltip" data-placement="top" title="T3A_DTADMI;"></i> Admissão
                                    </th>
                        ...
                        <form method="POST" action="<?= base_url($url . '/filtrar-dados'); ?>">
                            ...
                            <div class="modal-body p-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4 class="mb-0">
                                            <i class="fas fa-filter"></i> Filtrar exibição dos registros
                                        </h4>
                                    </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="T3A_DTADMI">Data da admissão</label>
